...
import {createNewProfile, getUserProfile} from '../../actions/profileAction';
...
class EditProfile extends Component {
  ...
  componentDidMount() {
	...
	render() {
		...
		return (
			<div>
				<h2 className="text-center mt-3">Edit Your Profile</h2>
...
export default connect(mapStateToProps, {createNewProfile, getUserProfile})(withRouter(EditProfile));
